							...
							<form class="form-area " id="myForm" action="mail.php" method="post" class="contact-form text-right">
								<div class="row">	
									<div class="col-lg-6 form-group">
										<input name="name" placeholder="Enter your full name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your full name'" class="common-input mb-20 form-control" required="" type="text">
									...
									<div class="col-lg-6 form-group">
										...
										<input type="submit" name="submit" class="primary-btn mt-20 text-white" value="Submit">								
									</div>
								</div>
							</form>	
						</div>
